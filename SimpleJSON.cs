...
namespace SimpleJSON {
    ...
    public class JObject {
        ...
        public static explicit operator JObject(string obj) { return CreateString(obj); }
        public static explicit operator JObject(bool obj) { return CreateBoolean(obj); }
        public static explicit operator JObject(double obj) { return CreateNumber(obj); }
        public static explicit operator JObject(float obj) { return CreateNumber(obj); }
        public static explicit operator JObject(ulong obj) { return CreateNumber(obj); }
        public static explicit operator JObject(long obj) { return CreateNumber(obj); }
        public static explicit operator JObject(uint obj) { return CreateNumber(obj); }
        public static explicit operator JObject(int obj) { return CreateNumber(obj); }
        public static explicit operator JObject(ushort obj) { return CreateNumber(obj); }
        public static explicit operator JObject(short obj) { return CreateNumber(obj); }
        public static explicit operator JObject(byte obj) { return CreateNumber(obj); }
        public static explicit operator JObject(sbyte obj) { return CreateNumber(obj); }
        ...
        public static JObject CreateNumber(sbyte n) { return CreateNumber(n < 0, false, false, (ulong)Math.Abs((long)n), 0, 0, 0); }
        public static JObject CreateNumber(short n) { return CreateNumber(n < 0, false, false, (ulong)Math.Abs((long)n), 0, 0, 0); }
        public static JObject CreateNumber(int n) { return CreateNumber(n < 0, false, false, (ulong)Math.Abs((long)n), 0, 0, 0); }
        public static JObject CreateNumber(long n) { return CreateNumber(n < 0, false, false, (ulong)n, 0, 0, 0); }

        public static JObject CreateNumber(byte n) { return CreateNumber(false, false, false, n, 0, 0, 0); }
        public static JObject CreateNumber(ushort n) { return CreateNumber(false, false, false, n, 0, 0, 0); }
        public static JObject CreateNumber(uint n) { return CreateNumber(false, false, false, n, 0, 0, 0); }
        public static JObject CreateNumber(ulong n) { return CreateNumber(false, false, false, n, 0, 0, 0); }

        public static JObject CreateNumber(float f) { return new JObject(f); }
        public static JObject CreateNumber(double f) { return new JObject(f); }
        ...
        private JObject(double f)
        {
            ...
            if (f > 0 && f <= Single.MaxValue)
            {
                MinFloat = FloatSize.Single;
                FloatValue = (float)f;
            }
            else if (f <= 0 && f >= Single.MinValue)
            {
                MinFloat = FloatSize.Single;
                FloatValue = (float)f;
            }
